 ...
 */
export function parseInterpolation(cursor: ParserCursor, _parseNode: NoArgsFunction<ASTNodeKind | undefined>, token: InterpolationExpressionToken | InterpolationLiteralToken): InterpolationNode {
  cursor.advance();
